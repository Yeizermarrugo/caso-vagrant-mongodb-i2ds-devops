...
ngrok config add-authtoken 2hRgdNOa4xISnHR58Sx7BIuDlCL_6JYmujjeQ3p2YS5EjcTgj
...
echo "Rundeck instalado y disponible en http://192.168.33.10:4440 con credenciales admin/admin"
